...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    ...
    KC_BRID,   _______,   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_END, \
    _______,   _______,  KC_LCTL, KC_LALT, MO(_FN1), KC_LGUI, KC_SPC,           KC_SPC,  KC_SPC,  KC_RALT, MO(_FN1), KC_RCTL,KC_LEFT, KC_DOWN, KC_RGHT
  ),
